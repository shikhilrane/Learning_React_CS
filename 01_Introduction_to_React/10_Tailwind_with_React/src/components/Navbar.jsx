    ...
    return (
      <nav className="flex p-6 items-center justify-between lg:p-8">
        ...
        <div id="auth-container" className="flex gap-8 items-center">
          {/* <LinkButton text={"Login"} className="hidden lg:block text-xl" /> */}
          ...
          <button className="cursor-pointer font-bold text-2xl text-black px-6 py-3 rounded-xl font-display hover:bg-yellow-300 hover:-translate-y-0.5 transition-all bg-gradient-to-br from-yellow-400 via-red-400 to bg-red-200">
            Sign up
          </button>
        </div>
      </nav>
